...
INSERT INTO `transaction` (`id`, `user_id`, `donation_id`, `category_id`, `amount`, `ref_id`, `token`, `description`, `gateway_name`, `status`, `deleted_at`, `created_at`, `updated_at`) VALUES
(3, 1, 1, 6, 300000, NULL, NULL, NULL, 'pay', 0, NULL, NULL, NULL),
(4, 1, NULL, 1, 460000, '3456', NULL, NULL, 'pay', 1, NULL, '2022-06-29 09:46:17', NULL),
(6, 1, NULL, 1, 300000, '9999999', NULL, 'پرداخت فطریه الان', 'pay', 1, NULL, '2023-06-05 19:30:00', NULL),
(7, 1, NULL, 1, 5600000, '456457', NULL, NULL, 'pay', 1, NULL, '2023-05-04 10:08:52', NULL),
(8, 1, NULL, 1, 300000, '4563', NULL, NULL, 'pay', 1, NULL, '2023-05-30 10:10:26', NULL),
(9, 1, NULL, 2, 460000, '346673', NULL, 'واریزکفاره', 'pay', 1, NULL, '2023-06-06 11:16:24', NULL),
(10, 1, NULL, 2, 560000, '34647', NULL, NULL, 'pay', 1, NULL, '2023-05-24 11:17:25', NULL),
(11, 1, NULL, 3, 789000, NULL, NULL, NULL, 'pay', 1, NULL, '2023-05-30 11:26:26', NULL);
...
ALTER TABLE `transaction`
  ...
  ADD KEY `transaction_donation_id_foreign` (`donation_id`),
...
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `transaction_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `transaction_donation_id_foreign` FOREIGN KEY (`donation_id`) REFERENCES `donations` (`id`) ON DELETE CASCADE,
