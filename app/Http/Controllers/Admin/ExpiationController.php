...
class ExpiationController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $totalAmount = 0 ;
        foreach ($expiations as $w) {
            $totalAmount+= $w->amount;
        }


        return view('admin.expiations.index' , compact('expiations' , 'sumWeek' , 'sumMonth' , 'sumYear' , 'totalAmount'));
    }
